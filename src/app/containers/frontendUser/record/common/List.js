        ...
        <Container fluid>
            <Row style={{ backgroundColor: "#f7f7f7" }} className="p-3 mb-3 recordHead">
                <Col xs={4} className="">
                    <Row>
                        <Col xs={1}>
                            <img src="http://jbwork.in/jbplatform-images/images/projectIcon.png" alt="" className="recordNameIcon" />
                        </Col>
                        <Col xs={11}>
                            <span className="recordName">{currentObject.label}</span>
                            <span className="recordSubName">({records.length}{" "} Item(s) found)</span>
                        </Col>
                    </Row>
                </Col>
                <Col xs={5} style={{ display: 'none' }}>
                    <SelectDropdown options={recentProjectTab} />
                </Col>

                <Col xs={8} style={{ display: "flex", justifyContent: "flex-end" }}>
                    <CustomButton
                        variant="dark"
                        text={"New " + currentObject.label}
                        type="submit"
                        className="mr-2"
                        id="createFieldSave"
